...
const EREDIVISIE_CLUBS = [
  ...
  { name: 'AZ', slug: 'az' },
  { name: 'FC Utrecht', slug: 'fc-utrecht' },
  { name: 'FC Twente', slug: 'fc-twente' },
  { name: 'Vitesse', slug: 'vitesse' },
  { name: 'SC Heerenveen', slug: 'sc-heerenveen' },
  { name: 'FC Groningen', slug: 'fc-groningen' },
  { name: 'Sparta Rotterdam', slug: 'sparta-rotterdam' },
  { name: 'PEC Zwolle', slug: 'pec-zwolle' },
  { name: 'Heracles Almelo', slug: 'heracles-almelo' },
  { name: 'Fortuna Sittard', slug: 'fortuna-sittard' },
  { name: 'Go Ahead Eagles', slug: 'go-ahead-eagles' },
  { name: 'NEC', slug: 'nec' },
  { name: 'RKC Waalwijk', slug: 'rkc-waalwijk' },
  { name: 'FC Volendam', slug: 'fc-volendam' },
